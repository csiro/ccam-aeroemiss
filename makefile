...
ifeq ($(ZEN3),yes)
XFLAGS = -qopenmp -axCORE-AVX2 -I $(NETCDF_ROOT)/include
endif
...
version.h: FORCE
	...
	echo "      character(len=*), parameter :: version ='AEROEMISS r'" > brokenver
	echo "      character(len=*), parameter :: version ='AEROEMISS r`svnversion .`'" > tmpver
